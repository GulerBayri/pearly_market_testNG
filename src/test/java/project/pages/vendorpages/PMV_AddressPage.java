...
public class PMV_AddressPage extends BasePage {
    ...
    public void clickaddForBillingAddress() {
        if (editBillingAddressButton.isEnabled()){
            JSUtils.clickWithTimeoutByJS(editBillingAddressButton);
        }else if (addBillingAddress.isEnabled()){
            JSUtils.clickWithTimeoutByJS(addBillingAddress);
        }
